...
base::options::toggle OptionDisableVulkanRhi({
	.id = kOptionDisableVulkanRhi,
	.name = "Disable Vulkan renderer",
	.description = "Use OpenGL for GPU rendering "
		"even when Vulkan is available.",
	.defaultValue = false,
...
#else // Q_OS_MAC || Q_OS_WIN
#if QT_CONFIG(vulkan)
	if (!OptionDisableVulkanRhi.value()) {
...
const char kOptionDisableVulkanRhi[] = "disable-vulkan-rhi";
